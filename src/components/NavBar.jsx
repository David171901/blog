    ...
    >
      ...
      {isOpen ? (
        <motion.div
          ...
          className="min-w-[70vw] sm:min-w-[90vw] flex flex-col justify-between z-30 items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-400 dark:bg-light/75 rounded-lg backdrop-blur-md py-32"
        >
